...
internal static class GenericModConfigMenuIntegration
{
    ...
    *********/
    ...
    public static void Register(IManifest manifest, IModRegistry modRegistry, IMonitor monitor, Func<ModConfig> getConfig, Action reset, Action save)
    {
        ...
        api.AddBoolOption(
            manifest,
            name: I18n.Config_UnpauseTimeDuringCutscenes_Name,
            tooltip: I18n.Config_UnpauseTimeDuringCutscenes_Desc,
            getValue: () => getConfig().UnpauseTimeDuringCutscenes,
            setValue: value => getConfig().UnpauseTimeDuringCutscenes = value
        );
